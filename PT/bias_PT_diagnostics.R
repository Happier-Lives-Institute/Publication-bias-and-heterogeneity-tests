...
mymodel <- rma(yi = d, sei = SE,  slab = Authors,
...
m.RE.full$n.e = dat$n.t; m.RE.full$n.c = dat$n.c
...
ggsave(filename = "PT/PT_funnel.png",
       plot = fun1,
       width = 8,
       height = 5,
       dpi = 1200)
...
p_obj <- tibble("studlab" = dat$Authors,
                "seTE"    = dat$SE,
                "TE"      = dat$d)
...
ggsave(filename = "PT/PT_pcurve.png",
       plot = the_curve,
       width = 8,
       height = 5,
       dpi = 1200)
